...
import Isomers.Request.Duplex (insert) as Request.Duplex
...
withAccept = Spec.spec ((Request.Duplex.insert (SProxy ∷ SProxy "test") (string segment)) /\ (((notFound (redirect i))) : HNil))

noAccept = Spec.spec ((Request.Duplex.insert (SProxy ∷ SProxy "fest") (string segment)) /\ (((notFound (redirect i)))))
...
oneLevel =
  Spec.spec
    ...
    --     Spec.spec ((Request.Duplex.insert (SProxy ∷ SProxy "fest") (string segment)) /\ (((notFound (redirect i))) : HNil))
    }
