...
var JSEngine = require("../Utils.JSEngine/foreign.js");

exports.fetchImpl = (function() {
  switch (JSEngine.jsEngine) {
    case JSEngine.browser:
      return window.fetch;
    case JSEngine.node:
...
exports.saveAttachmentImpl = (function() {
  ...
  var download = JSEngine.jsEngine === JSEngine.browser? browserDownload : nodeDownload;
