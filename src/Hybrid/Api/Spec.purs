...
import Hybrid.Contrib.Heterogeneous (hmap')
import Hybrid.Contrib.Heterogeneous.Mappings (Compose(..)) as Mappings
import Hybrid.Contrib.Heterogeneous.Mappings.Newtype (Unwrap(..)) as Mappings.Newtype
import Hybrid.Contrib.Heterogeneous.Mappings.Record (Get(..)) as Mappings.Record
import Hybrid.HTTP (Method(..)) as Hybrid.HTTP
import Hybrid.HTTP.Method (Method) as HTTP
...
method ∷
  ...
  t227 →
  Spec (Hybrid.HTTP.Method (Variant t235)) (Hybrid.HTTP.Method { | t221 })
method r = Spec { request, response: ResponseCodecs response }
  ...
  response = Hybrid.HTTP.Method (hmap' _ResponseMapping r)
