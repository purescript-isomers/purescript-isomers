module Hybrid.HTTP.Request.Accept where
...
import Hybrid.HTTP.ContentTypes (Jpeg, Png, Svg)
import Hybrid.HTTP.ContentTypes (Json, jpeg, json, png, svg) as ContentTypes
