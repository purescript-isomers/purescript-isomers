module Hybrid.HTTP.Fetch where
...
import Hybrid.HTTP.Response.Duplex (Duplex', decode) as Response
...
exchange ∷ ∀ a req res. RequestDuplex' req → req → Response.Duplex' Aff (Response res a) → Aff (Hybrid.HTTP.Exchange res req a)
