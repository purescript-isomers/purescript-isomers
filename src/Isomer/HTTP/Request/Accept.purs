module Isomer.HTTP.Request.Accept where
...
import Isomer.HTTP.ContentTypes (Jpeg, Png, Svg)
import Isomer.HTTP.ContentTypes (Json, jpeg, json, png, svg) as ContentTypes
