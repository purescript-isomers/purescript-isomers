module Isomer.HTTP.Request.Duplex where
...
import Isomer.Contrib.Heterogeneous.Mappings.Record (Delete(..), Get(..), Insert(..)) as Mappings.Record
import Isomer.Contrid.Heterogeneous.Mappings.Tuple (Cons(..), Fst(..), Snd(..)) as Tuple
import Isomer.HTTP.Request.Data (DataFolding(..), DataMapping(..))
