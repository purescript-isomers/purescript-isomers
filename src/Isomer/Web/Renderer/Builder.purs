module Isomer.Web.Renderer.Builder where
...
import Isomer.Web.Renderer.Types (Renderer)
import Isomer.HTTP (Exchange(..)) as HTTP
import Isomer.HTTP (Response(..))
import Isomer.HTTP.Response (OkF(..), Ok, _ok)
import Isomer.HTTP.Response.Duplex (Duplex') as Response
import Isomer.HTTP.Response.Duplex (fromJsonDual) as Response.Duplex
