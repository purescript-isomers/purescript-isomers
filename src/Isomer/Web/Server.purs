module Isomer.Web.Server where
...
-- import Isomer.Api.Server (Result) as Api.Server
-- import Isomer.Api.Server (Result) as Server
-- import Isomer.Api.Spec (ResponseCodec(..))
-- import Isomer.Web.Client.Router (RouterInterface)
-- import Isomer.Web.Client.Router (print) as Client.Router
...
--     print route = Client.Router.print codecs.request (Isomer.HTTP.Exchange route Nothing)
-- 
--     handlers' ∷ { | handlers' }
