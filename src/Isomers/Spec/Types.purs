...
-- | instances then....
newtype AccumSpec (body :: # Type) route ireq oreq res = AccumSpec
...
unifyRoute
  :: forall body ireq oreq res route route'
...
newtype Spec body ireq oreq res = Spec
...
-- | from `Request.Accum`.
rootAccumSpec :: forall body ireq oreq res. AccumSpec body {} ireq oreq res -> Spec body ireq oreq res
