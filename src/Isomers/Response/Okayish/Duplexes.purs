...
import Isomers.HTTP.ContentTypes (HtmlMime, JavascriptMime, JpegMime, JsonMime, _html, _json)
...
import Isomers.Response.Okayish.Type
  ( BadRequest
  , Found
  , Location
  , NotFound
...
type OkayishDuplex ct v i o = Duplex ct (Okayish v i) (Okayish v o)
...
-- | content type header.
injInto
  :: forall a b ct l i o li lo vi vi' vo vo'
   . IsSymbol l
  => Row.Cons l o () lo
  => Row.Union vo lo vo'
...
injStrangerInto
  :: forall a b ct ct' l i o li lo vi vi' vo vo'
   . IsSymbol l
  => Row.Cons l o () lo
  => Row.Union vo lo vo'
  => Row.Cons l o (Ok b + vo) (Ok b + vo')
...
wrapVariantDuplex
  :: forall a b ct vi vo
   . Duplex ct (Variant (Ok a + vi)) (Variant (Ok b + vo))
  -> Duplex ct (Okayish vi a) (Okayish vo b)
...
ok :: forall ct i o. Duplex ct i o -> Duplex ct (Okayish () i) (Okayish () o)
...
asJson
  :: forall t144 t145
   . (t145 -> Json)
  -> (Json -> Either String t144)
  -> Duplex JsonMime (Okayish () t145) (Okayish () t144)
...
notFound
  :: forall t105 t107 t110 t111 t113 t114 t115
