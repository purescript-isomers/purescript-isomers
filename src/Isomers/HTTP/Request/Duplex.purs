module Isomers.HTTP.Request.Duplex where
...
import Isomers.Contrid.Heterogeneous.Mappings.Tuple (Cons(..), Fst(..), Snd(..)) as Tuple
import Isomers.HTTP.Request.Data (DataFolding(..), DataMapping(..))
